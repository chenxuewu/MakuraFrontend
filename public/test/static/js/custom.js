(function($) {
	...
	$(document).ready(function() {
		...
		// Header Sticky for only-home-one-sticky
		$(window).on('scroll', function() {
		...
		$(".icon-view-three").on("click", function(e) {
			e.preventDefault();
			var filter = document.getElementById("products-filter");
			if (filter) {
				filter.classList.add('products-col-three');
				filter.classList.remove('products-col-two', 'products-col-four', 'products-row-view');
			}
		});
		...
		$(".view-grid-switch").on("click", function(e) {
			...
			var filter = document.getElementById("products-filter");
			if (filter) {
				filter.classList.add('products-row-view');
				filter.classList.remove('products-col-two', 'products-col-three', 'products-col-four');
			}
		});
