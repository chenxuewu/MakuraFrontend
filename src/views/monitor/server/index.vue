        ...
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  <th class="el-table__cell el-table__cell is-leaf"><div class="cell">磁碟路徑</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">檔案系統</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">磁碟型別</div></th>
...
export default {
  ...
  methods: {
    ...
    // 開啟載入層
    openLoading() {
      this.$modal.loading("正在載入伺服器監控資料，請稍候！");
    }
  }
};
</script>
