<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="呼叫目標字元串" align="center" prop="invokeTarget" :show-overflow-tooltip="true" />
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br />引數說明：支援字元串，布林型別，長整型，浮點型，整型
                  </div>
                  <i class="el-icon-question"></i>
                </el-tooltip>
              </span>
              <el-input v-model="form.invokeTarget" placeholder="請輸入呼叫目標字元串" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        invokeTarget: [
          { required: true, message: "呼叫目標字元串不能為空", trigger: "blur" }
        ],
        cronExpression: [
