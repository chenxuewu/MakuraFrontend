    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['product:collect:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['product:collect:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['product:collect:remove']"
        >刪除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['product:collect:export']"
        >匯出</el-button>
      </el-col>
...
<script>
import { listCollect, getCollect, delCollect, addCollect, updateCollect } from "@/api/product/collect";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否確認刪除使用者收藏商品中間編號為"' + ids + '"的資料項？').then(function() {
    ...
    /** 匯出按鈕操作 */
    handleExport() {
      this.download('product/collect/export', {
        ...this.queryParams
