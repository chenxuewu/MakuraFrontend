<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="單位符號" prop="unitSymbol">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['attribute:unit:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['attribute:unit:remove']"
        >刪除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['attribute:unit:export']"
        >匯出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="unitList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="ID" align="center" prop="unitId" /> -->
      <el-table-column label="單位名稱" align="center" prop="unitName" />
      <el-table-column label="單位符號" align="center" prop="unitSymbol" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="單位符號" prop="unitSymbol">
          <el-input v-model="form.unitSymbol" placeholder="請輸入單位符號" />
        </el-form-item>
...
<script>
import { listUnit, getUnit, delUnit, addUnit, updateUnit } from "@/api/product/attributeUnit";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        unitSymbol: [
          { required: true, message: "單位符號不能為空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否確認刪除該商品屬性單位的資料項？').then(function() {
    ...
    /** 匯出按鈕操作 */
    handleExport() {
      this.download('attribute/unit/export', {
        ...this.queryParams
