<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['product:location:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['product:location:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['product:location:remove']"
        >刪除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['product:location:export']"
        >匯出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="locationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="廠庫位置ID" align="center" prop="locationId" />
...
<script>
import { listLocation, getLocation, delLocation, addLocation, updateLocation } from "@/api/product/location";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否確認刪除商品倉庫位置編號為"' + locationIds + '"的資料項？').then(function() {
    ...
    /** 匯出按鈕操作 */
    handleExport() {
      this.download('product/location/export', {
        ...this.queryParams
