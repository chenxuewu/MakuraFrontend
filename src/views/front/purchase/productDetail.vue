                            ...
                            <div class="box">
                                <div class="box-one">
                                  <div class="box-two" style="width: 100%;">
                                    ...
                                    <div class="boxx-1">
<!--                                        <el-image class="img1" style="border-radius: 5px;width: 100%;"
                                      ...
                                      <ImageView :image-list="images" style="width: 100%;"/>
                                    </div>
                                  </div>
                                </div>
                            </div>
                          ...
                          <div class="box">
                            <div class="box-two" style="width: 100%;">
                              ...
                              <div class="box-btns clear" v-if="isFront" style="padding: 10px 0px 10px;">
                                      ...
                                      <div class="sku-row">
                                        <div class="sku-item-1">
                                          <dd style="border-radius: 5px;width: 95%;display: flex;"
                                              ...
                                              <img src="@/assets/front/image/car.jpg" alt="Image" style="border-radius: 10px;"/>
                                              <div style="width: 100%;">
                                        ...
                                        <div class="sku-item-1">
                                          <dd style="border-radius: 5px;width: 95%;display: flex;"
                                            ...
                                            <img src="@/assets/front/image/711.jpg" alt="Image" style="border-radius: 4px;"/>
                                            <div style="width: 100%;">
                                        ...
                                        <div class="sku-item-1">
                                          <dd style="border-radius: 5px;width: 95%;display: flex;"
                                            ...
                                            <img src="@/assets/front/image/familymart.jpg" alt="Image" style="border-radius: 6px;"/>
                                            <div style="width: 100%;">
                                ...
                                <div class="quantityLine" style="border-bottom: #cccccc 1px dashed;padding-bottom: 20px;">
                                  <el-form :model="form" :rules="rules" ref="form" label-width="20%">
                                    ...
                                    <el-form-item label="選擇地區" prop="cityName">
                                      <el-select
                                    ...
                                    <el-form-item label="選擇區域" prop="areaName">
                                      <el-select
                                    ...
                                    <el-form-item label="選擇街道" prop="streetName" v-if="dispathWayChoose !== 1">
                                      <el-select
                                    ...
                                    <el-form-item label="選擇商超" prop="storeName" v-if="dispathWayChoose !== 1">
                                      <el-select
                                    ...
                                    <el-form-item label="留言備註" prop="remark">
                                      <el-input
                                        style="width: 100%"
                                        type="text"
                                        icon="el-icon-edit"
                                ...
                                <div class="Actions--root--hwEujgc BasicContent--actions--1co8sx8">
                                  <button
                                    ...
                                    <span style="display: inline; font-size: 20px; font-weight: bold; color: rgb(255, 255, 255);">立即購買</span>
                                  </button>
                                </div>

                                <div class="Actions--root--hwEujgc BasicContent--actions--1co8sx8">
                                  <div  style="width: 100%; border-radius: 100px;background-color: #00c300;width: 100%;">
                                    <button
                                      class="Actions--btn--3islUTb Actions--leftBtn--3kx8kg8  Actions--primaryBtn--1UPmwd4"
                                      style="background: url(@/assets/images/line.dc7ba022.svg) no-repeat; vertical-align: top;width: 100%;">
                                      <img src="@/assets/images/line.dc7ba022.svg" alt="Image" />
                                      <span style="display: inline; font-size: 20px; font-weight: bold; color: rgb(255, 255, 255);">Line: 0976982467</span>
                                    </button>
                                  </div>
                                </div>
                              </div>
...
import ImageView from '@/views/front/components/ImageView/index.vue';
        ...
        return {
            ...
            rules: {
              ...
              phone: [
                ...
                { pattern: /^(?:[0-9] ?){6,14}[0-9]$/, message: '請輸入有效的國際電話號碼（如8613912345678）', trigger: 'blur' }
              ],
              cityName: [
              ...
              streetName: [
                { required: false, message: '請選擇街道', trigger: 'blur' }
              ],
              storeName: [
                { required: false, message: '請選擇商超', trigger: 'blur' }
              ],
              address: [
              ...
              remark: [
                { required: false, message: '請輸入留言備註' }
              ]
            }
        };
    },
    ...
    methods: {
      ...
      changeCity() {
        this.cityList.forEach((item) => {
          if (item.divisionName === this.form.cityName) {
            this.form.areaName = "";
            this.form.streetName = "";
            this.form.storeName = "";
            this.form.address = "";
            this.areaList = item.children;
            this.form.cityId = item.id; // 儲存cityId
            this.addressPath = item.divisionName; // 更新addressPath
          }
        });
      },
      ...
      changeArea() {
        this.areaList.forEach((item) => {
          if (item.divisionName === this.form.areaName) {
            this.form.streetName = "";
            this.form.storeName = "";
            this.form.address = "";
            this.form.areaId = item.id; // 儲存areaId
            this.addressPath = this.form.cityName + " > " + item.divisionName; // 更新addressPath

            const form = 'city=' + encodeURIComponent(this.form.cityName) +
                '&zone=' + encodeURIComponent(this.form.areaName) +
      ...
      changeStreet() {
        this.streetList.forEach((item) => {
          if (item === this.form.streetName) {
            this.form.storeName = "";
            this.form.address = "";

            const form = 'city=' + encodeURIComponent(this.form.cityName) +
              '&zone=' + encodeURIComponent(this.form.areaName) +
              '&road=' + encodeURIComponent(this.form.streetName) +
              '&deliveryType=' + this.dispathWayChoose;
      ...
      changeStore() {
        this.storeList.forEach((item) => {
          if (item.storeName === this.form.storeName) {
            this.form.address = item.storeAddr;
            this.form.streetName = item.road;
      ...
      buyProduct() {
        this.$refs.form.validate((valid) => {
          if (valid) {
            const formData = {
              sysUserAddress: {
                receivingName: this.form.name,
                receivingPhone: this.form.phone,
              ...
              messageToSeller: this.form.remark,
              xtOrderItemForms: [
                {
            ...
            addProductNoAuth(formData).then(response => {
              if (response.code === 200) {
                ...
                orderInfo.isNewUser = response.isNewUser;
