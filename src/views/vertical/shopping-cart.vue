                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td class="product-name">
                      <router-link to="/vertical/product-details">DFMALB 20V Max XX Oscillating Multi <br> Tool Variable
                        Speed Tool
                      </router-link>
                    </td>
...
<i class="ri-add-line"></i>
            ...
            <div class="coupon-cart">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <router-link to="/vertical/checkout" class="default-btn update-cart">
                    更新購物車
                  </router-link>
                </div>
              </div>
          ...
          <div class="col-lg-3">
            <div class="cart-totals">
              <h3 class="cart-checkout-title">購物車總計</h3>
              <ul>
                <li>小計 <span>$240.00</span></li>
                <li>運費 <span>$00.00</span></li>
                <li>總計 <span>$315.00</span></li>
                <li><b>應付總額</b> <span><b>$240.00</b></span></li>
              </ul>
              <router-link to="/vertical/checkout" class="default-btn">
                前往結帳
              </router-link>
