...
<h3>哎呀！找不到頁面</h3>
<p>你要找的頁面不存在。</p>
<router-link to="/vertical/index" class="default-btn two">
返回首頁
</router-link>
</div>
</div>
  ...
  <div class="row align-items-center">
   ...
   <div class="col-lg-5">
    <form class="newsletter-form" data-toggle="validator">
     <input type="email" class="form-control" placeholder="你的電子郵件" name="EMAIL" required="" autocomplete="off">
    ...
    <div class="row align-items-center">
     <div class="col-lg-6">
      <div class="modal-newsletter">
       ...
       <form class="newsletter-form" data-toggle="validator">
        <input type="email" class="form-control" placeholder="輸入電子郵件地址" name="EMAIL" required="" autocomplete="off">
