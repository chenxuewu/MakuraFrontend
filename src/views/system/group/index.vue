<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="skuID" prop="skuId">
        <el-input
          ...
          placeholder="請輸入skuID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="sku編碼" prop="skuSn">
        <el-input
      ...
      <el-form-item label="店鋪商品價格" prop="price">
        <el-input
          v-model="queryParams.price"
          placeholder="請輸入店鋪商品價格"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="sku編碼" align="center" prop="skuSn" />
      <el-table-column label="店鋪商品價格" align="center" prop="price" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="skuID" prop="skuId">
          <el-input v-model="form.skuId" placeholder="請輸入skuID" />
        </el-form-item>
        <el-form-item label="sku編碼" prop="skuSn">
          <el-input v-model="form.skuSn" placeholder="請輸入sku編碼" />
        </el-form-item>
        <el-form-item label="店鋪商品價格" prop="price">
          <el-input v-model="form.price" placeholder="請輸入店鋪商品價格" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否確認刪除團長店鋪和商品中間 編號為"' + ids + '"的資料項？').then(function() {
        return delGroup(ids);
      }).then(() => {
        this.getList();
