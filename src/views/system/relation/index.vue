<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="包裹表ID" prop="orderPackageId">
        <el-input
          v-model="queryParams.orderPackageId"
          placeholder="請輸入包裹表ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="訂單商品ID" prop="orderItemId">
        <el-input
          v-model="queryParams.orderItemId"
          placeholder="請輸入訂單商品ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="relationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="包裹表ID" align="center" prop="orderPackageId" />
      <el-table-column label="訂單商品ID" align="center" prop="orderItemId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="包裹表ID" prop="orderPackageId">
          <el-input v-model="form.orderPackageId" placeholder="請輸入包裹表ID" />
        </el-form-item>
        <el-form-item label="訂單商品ID" prop="orderItemId">
          <el-input v-model="form.orderItemId" placeholder="請輸入訂單商品ID" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否確認刪除訂單包裹和商品中間 編號為"' + ids + '"的資料項？').then(function() {
