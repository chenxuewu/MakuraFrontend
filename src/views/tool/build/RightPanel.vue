    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.componentName!==undefined" label="元件名稱">
          ...
          <el-form-item v-if="activeData.span!==undefined" label="表單網格">
            <el-slider v-model="activeData.span" :max="24" :min="1" :marks="{12:''}" @change="spanChange" />
          </el-form-item>
          <el-form-item v-if="activeData.layout==='rowFormItem'" label="網格間隔">
            <el-input-number v-model="activeData.gutter" :min="0" placeholder="網格間隔" />
          </el-form-item>
          ...
          <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select'].indexOf(activeData.tag) > -1">
            ...
            >
              <div v-for="(item, index) in activeData.options" :key="index" class="select-item">
                ...
                <el-input v-model="item.label" placeholder="選項名稱" size="small" />
                <el-input
                  placeholder="選項值"
                  size="small"
                  :value="item.value"
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          <el-form-item label="表單名稱">
            <el-input v-model="formConf.formRef" placeholder="請輸入表單名稱（ref）" />
          </el-form-item>
          ...
          <el-form-item label="網格間隔">
            <el-input-number v-model="formConf.gutter" :min="0" placeholder="網格間隔" />
          </el-form-item>
